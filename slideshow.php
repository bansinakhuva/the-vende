		...
		<div id="outer_container">
			<div class="thumbScroller">
				<div class="container">
					...
					<a href="profile.php" class="btn btn-default" style="cursor: pointer; position: fixed; bottom: 20px; right: 20px;" title="Click to return on Album page">Back to Home</a>
				</div>
			</div>
		</div>
	</div>
